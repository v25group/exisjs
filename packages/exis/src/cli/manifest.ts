...
export async function generateManifest(
  ...
  // Check if it's a TS project, if so, generate exis.d.ts in root
  ...
  if (isTsProject) {
    const exisEnvContent = `/// <reference types="exisjs" />
...
`
    await fs.writeFile(path.join(cwd, 'exis.d.ts'), exisEnvContent, 'utf8')
  }
}
