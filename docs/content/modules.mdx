...
#### Class-Based (OOP) Paradigm (`@Module`)

For applications following the OOP paradigm, you can define modules using the `@Module` class decorator:

```typescript filename="src/modules/auth.module.ts"
import { Module } from 'exisjs/module'
...
You can then register it into your server:
